...
import ScrollSVG from "../../assets/home/scroll.json";
...
export function Home({ theme, t }) {
  ...
  return (
    <article id="home" className={theme} onMouseMove={moveElements}>
      <h1 data-speedx={30} data-speedy={0}>
        Matheus Gesser
      </h1>
      <h2 data-speedx={25} data-speedy={0}>
        {t("position")}
      </h2>
      ...
      <Lottie animationData={ScrollSVG} style={{ width: "4.5rem" }} />
      <img
        src={JSLogo}
        id="js"
        data-speedx={-30}
